...
let plugins = [
  new BitBarWebpackProgressPlugin(), new ProgressPlugin(true), new FriendlyErrorsWebpackPlugin(), new webpack.BannerPlugin(
    'This file is created by hbq'), // 生成文件时加上注释
  ...
  new ExtractTextPlugin({
    filename: `css/${__DEV__ ? '[name].css' : '[name].min.css'}`
  })
]
